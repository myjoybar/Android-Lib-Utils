package com.joy.libbase.base.view.verification;
...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
	...
	public VerificationCodeView(Context context, AttributeSet attrs) {
		...
		@SuppressLint({"Recycle", "CustomViewStyleable"}) TypedArray typedArray = context.obtainStyledAttributes(attrs,
				R.styleable.vericationCodeView);
		...
		mEtTextBg = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_bg, R.drawable.et_code);
...
//		}
	...
	private void focus() {
		if (onCodeFinishListener != null) {
			onCodeFinishListener.onUnfinished();
		}
