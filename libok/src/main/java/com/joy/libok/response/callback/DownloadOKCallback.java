...
public class DownloadOKCallback<T> implements Callback {
	...
	public DownloadOKCallback(Long completeBytes, String filePath, DownloadResponseHandler responseHandler) {
	...
	private void saveFile(Response response, String requestUrl, String filePath, Long completeBytes) throws IOException {
