package com.joybar.library.common.drawable;
...
public class DrawbleUtils {
	// GradientDrawable
	public static GradientDrawable setGradientDrawable(Context context, String color, int rLeftTop, int rRightTop, int rRightBottom, int
			rLeftBottom) {
		...
		gd.setShape(GradientDrawable.RECTANGLE);// 矩形
		float[] r = {ScreenUtils.convertDipToPx(context, rLeftTop), ScreenUtils.convertDipToPx(context, rLeftTop), ScreenUtils.convertDipToPx
				(context, rRightTop), ScreenUtils.convertDipToPx(context, rRightTop), ScreenUtils.convertDipToPx(context, rRightBottom), ScreenUtils
				.convertDipToPx(context, rRightBottom), ScreenUtils.convertDipToPx(context, rLeftBottom), ScreenUtils.convertDipToPx(context,
				rLeftBottom)};
		gd.setCornerRadii(r);
		//  gd.setCornerRadius();
		return gd;
